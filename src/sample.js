...
console.log(_404_, "404");
console.log(상세페이지_로딩, "상세페이지_로딩");
console.log(상세페이지_로딩완료, "상세페이지_로딩완료");
console.log(상품목록_레이아웃_로딩, "상품목록_레이아웃_로딩");
console.log(상품목록_레이아웃_로딩완료, "상품목록_레이아웃_로딩완료");
console.log(상품목록_레이아웃_카테고리_1Depth, "상품목록_레이아웃_카테고리_1Depth");
console.log(상품목록_레이아웃_카테고리_2Depth, "상품목록_레이아웃_카테고리_2Depth");
console.log(토스트, "토스트");
console.log(장바구니_비어있음, "장바구니_비어있음");
console.log(장바구니_선택없음, "장바구니_선택없음");
console.log(장바구니_선택있음, "장바구니_선택있음");
