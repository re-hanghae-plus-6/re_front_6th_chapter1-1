export const MainList = (loading = false) => {
  if (loading) {
              ...
              <div class="grid grid-cols-2 gap-4 mb-6" id="products-grid">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden product-card"
                  ...
                  <div class="p-3">
                    ...
                    <!-- 장바구니 버튼 -->
                    <button class="w-full bg-blue-600 text-white text-sm py-2 px-3 rounded-md hover:bg-blue-700 transition-colors add-to-cart-btn" data-product-id="86940857379">
                      장바구니 담기
                    </button>
                  </div>
                </div>
