...
export const HomePage = ({ categories, products, total, loading }) => {
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-2">
              ...
              ${loading ? `<div class="text-sm text-gray-500 italic">카테고리 로딩 중...</div>` : categoryList.map((category) => category)}
              </div>
              <!-- 2depth 카테고리 -->
            </div>
            <!-- 기존 필터들 -->
