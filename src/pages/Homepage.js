...
export const HomePage = ({ products = [], total = 0, loading = false, categories }) => {
    // categories 객체의 key 값만 배열로 추출
            ...
            <div class="space-y-3">
                ...
                <div class="flex flex-wrap gap-2">
                    ${loading ? 
                        ...
                        `${categoryList.map(
                            (cat) => `
                                <button data-category1="${cat}" class="category1-filter-btn text-left px-3 py-2 text-sm rounded-md border transition-colors
