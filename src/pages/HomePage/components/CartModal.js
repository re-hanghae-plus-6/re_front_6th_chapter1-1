export class CartModal {
  constructor({ getState, setState, selector = document.body }) {
    this.root = selector;
    this.element = null;
            ...
            ${cart.map(
              (
                ...
                <div class="w-16 h-16 bg-gray-100 rounded-lg overflow-hidden mr-3 flex-shrink-0">
                  <img src="${product.image}" alt="${product.title}" class="w-full h-full object-cover cursor-pointer cart-item-image" data-product-id="85067212996">
                </div>
                <!-- 상품 정보 -->
