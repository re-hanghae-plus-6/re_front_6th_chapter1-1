...
const loadingUIList = Array.from({ length: 4 }, () => loadingUI).join("");
...
export const productListPage = ({ products = [], loading = false, total = 0, categories }) => {
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-2">
              ...
              <div class="flex flex-wrap gap-2">
                ${loading ? `<div class="text-sm text-gray-500 italic"> 카테고리 로딩 중... </div>` : `${categoryList.map(categoryDepth1).join("")}`}
              </div>
              <!-- 2depth 카테고리 -->
