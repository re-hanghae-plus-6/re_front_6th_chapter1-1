...
export function ProductDetail(productId) {
  async function init() {
    ...
    state.relatedProducts = relatedProducts.products;
        ...
        <div class="bg-white rounded-lg shadow-sm mb-6">
          ...
          <div class="p-4">
            <div class="aspect-square bg-gray-100 rounded-lg overflow-hidden mb-4">
               <img src="${state.product.image}" alt="${state.product.title}" class="w-full h-full object-cover state.product-detail-image">
            </div>
            <!-- 상품 정보 -->
            <div>
