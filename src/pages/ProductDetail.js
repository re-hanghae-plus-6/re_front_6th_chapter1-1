              ...
              <div class="flex items-center mb-3">
                <div class="flex items-center">
                  ${Array(5)
                    ...
                    .map(
                      (_, i) => `
                    <svg class="w-4 h-4 ${i < Math.floor(product.rating || 0) ? "text-yellow-400" : "text-gray-300"}" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span class="ml-2 text-sm text-gray-600">${product.rating || 0} (${product.reviewCount || 0}개 리뷰)</span>
              </div>
              <!-- 가격 -->
              <div class="mb-4">
                <span class="text-2xl font-bold text-blue-600">${product.price}원</span>
              </div>
              <!-- 재고 -->
                ...
                ${relatedProducts
                  ...
                  .map(
                    ...
                    <div class="bg-gray-50 rounded-lg p-3 related-product-card cursor-pointer" data-product-id="${relatedProduct.id}">
                      ...
                      <p class="text-sm font-bold text-blue-600">${relatedProduct.price}원</p>
                    </div>
                  `,
                  )
                  .join("")}
