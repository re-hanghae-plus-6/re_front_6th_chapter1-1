      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-2">
              ...
              ${
                categories.length > 0
                  ...
                  <button data-category1="${cat.name}" class="category1-filter-btn text-left px-3 py-2 text-sm rounded-md border transition-colors
                     ${selectedCategory1 === cat.name ? "bg-blue-100 border-blue-300 text-blue-800" : "bg-white border-gray-300 text-gray-700 hover:bg-gray-50"}">
                    ${cat.name}
                  </button>
                `,
                      )
            ...
            <!-- 2depth 카테고리 -->
            ${
              selectedCategory1 && categories.find((cat) => cat.name === selectedCategory1)?.subcategories
                ? `
              <div class="space-y-2">
                <div class="flex flex-wrap gap-2">
                  ${categories
                    ...
                    ?.subcategories.map(
                      (subcat) => `
                    <button data-category1="${selectedCategory1}" data-category2="${subcat}" class="category2-filter-btn text-left px-3 py-2 text-sm rounded-md border transition-colors
                       ${selectedCategory2 === subcat ? "bg-blue-100 border-blue-300 text-blue-800" : "bg-white border-gray-300 text-gray-700 hover:bg-gray-50"}">
                      ${subcat}
                    </button>
                  `,
                    )
