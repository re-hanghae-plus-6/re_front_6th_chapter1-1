...
export const ProductDetailPage = ({ product, cart = [], relatedProducts = [] }) => {
  if (!product) {
    return `
  ...
  return `
    <div class="min-h-screen bg-gray-50">
      ${Header({ cart, isProductDetail: true })}
      <main class="max-w-md mx-auto px-4 py-4">
        ...
        <nav class="mb-4">
          <div class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span class="text-gray-500">${product.category1}</span>
            ${
              product.category2
                ? `
            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span class="text-gray-500">${product.category2}</span>
            `
                : ""
            }
          </div>
          ...
          <div class="p-4">
            ...
            <div>
              ...
              <div class="flex items-center mb-3">
                ...
                <span class="ml-2 text-sm text-gray-600">4.0 (${Math.floor(Math.random() * 1000)}개 리뷰)</span>
              </div>
